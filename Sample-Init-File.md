---
tip: translate by openai@2023-06-24 02:16:17
...
---
description: Sample Init File (Debugging with GDB)
distribution: global
Generator: makeinfo
keywords: Sample Init File (Debugging with GDB)
lang: en
...
> 这里是一个`inputrc`文件的示例。这个示例展示了按键绑定、变量赋值和条件语法。
